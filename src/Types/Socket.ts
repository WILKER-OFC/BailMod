...
export type SocketConfig = {
	...
	/**
	 * Group metadata cache TTL in ms.
	 * - Set to 0 to disable caching entirely.
	 * - Reduces repeated `groupMetadata()` calls (less load & faster handler/admin checks).
	 */
	groupMetadataCacheTtlMs: number

	/**
	 * Max entries for the in-memory group metadata cache.
	 * Keep this modest for low-RAM VPS.
	 */
